...
\author{Pratik S. Sachdeva$^{1}$ and Kristofer E. Bouchard$^{2}$% <-this % stops a space
\thanks{$^{1}$Albert Author is with Faculty of Electrical Engineering, Mathematics and Computer Science,
        University of California, Berkeley, 7500 AE Enschede, The Netherlands
