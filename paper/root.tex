...
\begin{itemize}
    ...
    \item \textbf{Selection Ratio:} The fraction of non-zero fitted features to the number of available . Alternatively, we refer to the model size, or the number of fitted non-zero features.
...
\begin{figure}[t]
    \centering
    \scalebox{0.40}{\includegraphics{./img/Fig6/Fig6}}
    \vspace{-15pt}
